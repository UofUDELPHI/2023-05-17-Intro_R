...
address: "EHSEB 2680, 26 2000 E, Salt Lake City, UT 84113"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "May 17-18, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Rebecca Barter", "George Vega Yon"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Linda Amoafo", "Eric Anto", "Kline Dubose"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["penny.atkins@hsc.utah.edu", "rebecca.barter@hsc.utah.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<p id="requirements">
  ...
  {% endif %}
  For instructions on installing R and RStudio, see the "Setup" section (<a href="#setup">below</a>).
</p>
...
<p>
We will use this <a href="https://pad.carpentries.org/intro-r-05-17">etherpad (collaborative document)</a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
<hr/>
