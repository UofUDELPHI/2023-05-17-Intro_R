...
vectors and rows are data frames.* We can also glue two data frames
together with `rbind`:
...
is a *list of vectors and factors*. When `length` gave us 6, it's because gapminder is built out of a list of 6
