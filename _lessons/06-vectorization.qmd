...
criteria. Several operations for combining logical vectors exist in R:
...
Nothing, because there is no value that is equal to both 5.4 and 7 at the same time!
